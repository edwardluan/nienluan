...
<?php
// Check if 'author' key exists in the $_POST array
		...
		<div class="margin-top">
			...
			<div class="span12">	
			   <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Bảng</strong>
                                </div>
						<!--  -->
								    <ul class="nav nav-pills">
										<li   class="active"><a href="books.php">Tất cả</a></li>
										<li><a href="new_books.php">Sách mới</a></li>
										<li><a href="old_books.php">Sách mới</a></li>
										<li><a href="lost.php">Sách mất</a></li>
										<li><a href="damage.php">Sách hư hại</a></li>
										<li><a href="sub_rep.php">Đối tượng thay thế</a></li>
									</ul>
						<!--  -->
						<center class="title">
						<h1>Books List</h1>
